...
import (
	...
	versionedscheme "knative.dev/eventing-blockchain/pkg/client/clientset/versioned/scheme"
	client "knative.dev/eventing-blockchain/pkg/client/injection/client"
	blockchainsource "knative.dev/eventing-blockchain/pkg/client/injection/informers/sources/v1alpha1/blockchainsource"
...
const (
	defaultControllerAgentName = "blockchainsource-controller"
	defaultFinalizerName       = "blockchainsources.sources.knative.dev"
)
...
func NewImpl(ctx context.Context, r Interface, optionsFns ...controller.OptionsFn) *controller.Impl {
	...
	blockchainsourceInformer := blockchainsource.Get(ctx)

	lister := blockchainsourceInformer.Lister()
	...
	logger = logger.With(
		...
		zap.String(logkey.Kind, "sources.knative.dev.BlockchainSource"),
	)
